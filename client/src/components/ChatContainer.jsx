...
const ChatContainer = ({
    ...
    if (isPrivateChat(currentRoom) && partnerName && requestedFriends && requestedFriends.includes(partnerName)) {
        friendRequestStatus = 'sent';
    } else if (
        isPrivateChat(currentRoom) && partnerName && friendRequests && friendRequests.some(r => r.from === partnerName && r.to === myname)
    ) {
